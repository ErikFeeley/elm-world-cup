...
var _user$project$Data_Match$Match = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
									...
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return {venue: a, location: b, status: c, time: d, fifaId: e, datetime: f, lastEventUpdateAt: g, lastScoreUpdateAt: h, homeTeam: i, awayTeam: j, winner: k, winnerCode: l, homeTeamEvents: m, awayTeamEvents: n};
													};
												};
											};
										};
...
var _user$project$Data_Match$Team = F3(
	function (a, b, c) {
		return {country: a, code: b, goals: c};
	});
var _user$project$Data_Match$decodeMatchHome_team = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Data_Match$Team,
	...
	A2(_elm_lang$core$Json_Decode$field, 'goals', _elm_lang$core$Json_Decode$int));
var _user$project$Data_Match$decodeMatchAway_team = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Data_Match$Team,
	A2(_elm_lang$core$Json_Decode$field, 'country', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'code', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'goals', _elm_lang$core$Json_Decode$int));
var _user$project$Data_Match$Event = F4(
	function (a, b, c, d) {
		return {id: a, typeOfEvent: b, player: c, time: d};
	});
var _user$project$Data_Match$decodeEvent = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$Data_Match$Event,
	A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'type_of_event', _elm_lang$core$Json_Decode$string),
...
var _user$project$Data_Match$decodeMatch = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'away_team_events',
	_elm_lang$core$Json_Decode$list(_user$project$Data_Match$decodeEvent),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'home_team_events',
		_elm_lang$core$Json_Decode$list(_user$project$Data_Match$decodeEvent),
		A4(
			...
			A4(
				...
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'away_team',
					_user$project$Data_Match$decodeMatchAway_team,
					A3(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
						'home_team',
						_user$project$Data_Match$decodeMatchHome_team,
						A3(
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
											...
											A3(
												...
												A3(
													...
													A3(
														...
														'venue',
														_elm_lang$core$Json_Decode$string,
														_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Data_Match$Match)))))))))))))));

var _user$project$Data_TeamResult$TeamResult = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
									...
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return {id: a, country: b, alternateName: c, fifaCode: d, groupId: e, groupLetter: f, wins: g, draws: h, losses: i, gamesPlayed: j, points: k, goalsFor: l, goalsAgainst: m, goalDifferential: n};
													};
												};
											};
										};
...
var _user$project$Data_TeamResult$decodeTeamResult = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'goal_differential',
											...
											A4(
												...
												A3(
													...
													A3(
														...
														'id',
														_elm_lang$core$Json_Decode$int,
														_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Data_TeamResult$TeamResult)))))))))))))));
...
var _user$project$Route$TeamResult = {ctor: 'TeamResult'};
...
var _user$project$Route$route = _evancz$url_parser$UrlParser$oneOf(
	{
		...
		_1: {
			...
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Route$TeamResult,
...
var _user$project$Views_Page$loader = function (isLoading) {
	return isLoading ? _user$project$Views_Spinner$spinner : _elm_lang$html$Html$text('');
};
								...
								},
								{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Team Results'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _user$project$Views_Page$loader(isLoading),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
...
var _user$project$Views_Page$TeamResult = {ctor: 'TeamResult'};
...
var _user$project$Request_Helpers$apiUrl = function (str) {
	return A2(_elm_lang$core$Basics_ops['++'], 'https://world-cup-json.herokuapp.com', str);
};

var _user$project$Request_Match$todaysMatches = A2(
	_elm_lang$http$Http$get,
	_user$project$Request_Helpers$apiUrl('/matches/today'),
	_elm_lang$core$Json_Decode$list(_user$project$Data_Match$decodeMatch));

var _user$project$Page_Home$viewMatch = function (match) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
									...
									_0: A2(
										...
										},
										{
											...
											_0: _elm_lang$html$Html$text(
												A2(_elm_lang$core$Basics_ops['++'], 'Venue: ', match.venue)),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													A2(_elm_lang$core$Basics_ops['++'], 'Location: ', match.location)),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{ctor: '[]'},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(
														A2(_elm_lang$core$Basics_ops['++'], 'When: ', match.status)),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													{ctor: '[]'},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															A2(_elm_lang$core$Basics_ops['++'], 'Time: ', match.datetime)),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{ctor: '[]'},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																A2(_elm_lang$core$Basics_ops['++'], 'Home Team: ', match.homeTeam.code)),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
															...
															{ctor: '[]'},
															{
																...
																_0: _elm_lang$html$Html$text(
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		'Home Team Goals: ',
																		_elm_lang$core$Basics$toString(match.homeTeam.goals))),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: A2(
																...
																{ctor: '[]'},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text(
																		A2(_elm_lang$core$Basics_ops['++'], 'Away Team: ', match.awayTeam.code)),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																	...
																	{ctor: '[]'},
																	{
																		...
																		_0: _elm_lang$html$Html$text(
																			A2(
																				_elm_lang$core$Basics_ops['++'],
																				'Away Team Goals: ',
																				_elm_lang$core$Basics$toString(match.awayTeam.goals))),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		...
																		{ctor: '[]'},
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(
																				A2(_elm_lang$core$Basics_ops['++'], 'Winner (if there is yet): ', match.winner)),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
...
var _user$project$Page_Home$viewMatches = function (matches) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(_elm_lang$core$List$map, _user$project$Page_Home$viewMatch, matches));
};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Page_Home$viewMatches(model.matches),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$Page_Home$init = function () {
	var handleLoadError = function (_p0) {
		return A2(_user$project$Page_Errored$pageLoadError, _user$project$Views_Page$Home, 'Matches failed to load');
	};
	var loadMatches = _elm_lang$http$Http$toTask(_user$project$Request_Match$todaysMatches);
	return A2(
		_elm_lang$core$Task$mapError,
		handleLoadError,
		A2(_elm_lang$core$Task$map, _user$project$Page_Home$Model, loadMatches));
}();
...
var _user$project$Request_TeamResult$getTeamResults = A2(
	_elm_lang$http$Http$get,
	_user$project$Request_Helpers$apiUrl('/teams/results'),
	_elm_lang$core$Json_Decode$list(_user$project$Data_TeamResult$decodeTeamResult));

var _user$project$Page_TeamResult$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'SetSearch') {
			var _p1 = _p0._0;
			return {
				ctor: '_Tuple2',
						...
						searchResults: _elm_lang$core$String$isEmpty(_p1) ? {ctor: '[]'} : A2(
							...
							function (r) {
								return A2(
									...
									_elm_lang$core$String$toLower(r.fifaCode)) || A2(
									_elm_lang$core$String$contains,
									_elm_lang$core$String$toLower(_p1),
									_elm_lang$core$String$toLower(r.country));
							},
							model.teamResults)
					}),
...
var _user$project$Page_TeamResult$viewSelectedTeam = function (team) {
	var _p2 = team;
	if (_p2.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$span,
					...
					},
					{
						...
						_0: A2(
							...
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(_elm_lang$core$Basics_ops['++'], 'Country: ', _p3.country)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										A2(_elm_lang$core$Basics_ops['++'], 'FIFA Code: ', _p3.fifaCode)),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											A2(
												_elm_lang$core$Basics_ops['++'],
												'Games Played: ',
												_elm_lang$core$Basics$toString(_p3.gamesPlayed))),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
										...
										{ctor: '[]'},
										{
											...
											_0: _elm_lang$html$Html$text(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'Wins: ',
													_elm_lang$core$Basics$toString(_p3.wins))),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
											...
											{ctor: '[]'},
											{
												...
												_0: _elm_lang$html$Html$text(
													A2(
														_elm_lang$core$Basics_ops['++'],
														'Losses: ',
														_elm_lang$core$Basics$toString(_p3.losses))),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
												...
												{ctor: '[]'},
												{
													...
													_0: _elm_lang$html$Html$text(
														A2(
															_elm_lang$core$Basics_ops['++'],
															'Goals For: ',
															_elm_lang$core$Basics$toString(_p3.goalsFor))),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
													...
													{ctor: '[]'},
													{
														...
														_0: _elm_lang$html$Html$text(
															A2(
																_elm_lang$core$Basics_ops['++'],
																'Goals Agains: ',
																_elm_lang$core$Basics$toString(_p3.goalsAgainst))),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
														...
														{ctor: '[]'},
														{
															...
															_0: _elm_lang$html$Html$text(
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	'Goal Differential: ',
																	_elm_lang$core$Basics$toString(_p3.goalDifferential))),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
...
var _user$project$Page_TeamResult$Model = F4(
	function (a, b, c, d) {
		return {searchInput: a, searchResults: b, selectedTeam: c, teamResults: d};
	});
var _user$project$Page_TeamResult$init = function () {
	var handleLoadError = function (_p4) {
		return A2(_user$project$Page_Errored$pageLoadError, _user$project$Views_Page$TeamResult, 'Team results failed to load');
	};
	var loadTeamResults = _elm_lang$http$Http$toTask(_user$project$Request_TeamResult$getTeamResults);
	return A2(
		_elm_lang$core$Task$mapError,
		handleLoadError,
		A2(
			_elm_lang$core$Task$map,
			A3(
				_user$project$Page_TeamResult$Model,
				'',
				{ctor: '[]'},
				_elm_lang$core$Maybe$Nothing),
			loadTeamResults));
}();
var _user$project$Page_TeamResult$SetSelectedTeam = function (a) {
	return {ctor: 'SetSelectedTeam', _0: a};
};
var _user$project$Page_TeamResult$viewResults = function (searchResults) {
	return A2(
		_elm_lang$core$List$map,
		function (r) {
			return A2(
				_elm_lang$html$Html$a,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Page_TeamResult$SetSelectedTeam(r.id)),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(r.country),
					_1: {ctor: '[]'}
				});
		},
		searchResults);
};
var _user$project$Page_TeamResult$viewSearchResults = function (searchResults) {
	var _p5 = searchResults;
	if (_p5.ctor === '[]') {
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Found Teams'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$div,
										{ctor: '[]'},
										_user$project$Page_TeamResult$viewResults(searchResults)),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
			...
			_0: A2(
				...
				},
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _user$project$Page_TeamResult$viewSelectedTeam(model.selectedTeam),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _user$project$Main$TeamResultLoaded = function (a) {
	return {ctor: 'TeamResultLoaded', _0: a};
};
...
var _user$project$Main$setRoute = F2(
	function (maybeRoute, model) {
		...
		if (_p4.ctor === 'Nothing') {
			...
			switch (_p4._0.ctor) {
				case 'Home':
					return A2(transition, _user$project$Main$HomeLoaded, _user$project$Page_Home$init);
				case 'Root':
					return {
						ctor: '_Tuple2',
						_0: model,
				...
				default:
					return A2(transition, _user$project$Main$TeamResultLoaded, _user$project$Page_TeamResult$init);
			}
		}
	});
...
var _user$project$Main$updatePage = F3(
	function (page, msg, model) {
		...
		switch (_p6._0.ctor) {
				...
				if (_p6._0._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _user$project$Main$Loaded(
									_user$project$Main$Home(_p6._0._0._0))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
				...
				if (_p6._0._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								pageState: _user$project$Main$Loaded(
									_user$project$Main$TeamResult(_p6._0._0._0))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			default:
				if (_p6._1.ctor === 'TeamResult') {
					return A5(toPage, _user$project$Main$TeamResult, _user$project$Main$TeamMsg, _user$project$Page_TeamResult$update, _p6._0._0, _p6._1._0);
				} else {
